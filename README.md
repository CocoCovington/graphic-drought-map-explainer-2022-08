# Drought Map Explainer

This `graphic` was created using [`data-visuals-create`](https://github.com/texastribune/data-visuals-create) 7.3.0 on 2022-08-18.
-[Link to your project](https://capybara-test.texastribune.org/graphics/drought-map-explainer-2022-08/)
-[Link to your doc](https://docs.google.com/document/d/1txy_V1JfjH_q7HXyCC77vYwbSsubPVvT2SqnTlhdcrk)
